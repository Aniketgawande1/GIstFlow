...
//         <div className="mt-6">
//           <h3 className="text-md font-medium text-gray-200 dark:text-gray-300 mb-2">Summary Style</h3>
  ...
  return (
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="mt-6">
          {/* Changed text color from text-gray-200 to text-gray-700 for better visibility in light mode */}
